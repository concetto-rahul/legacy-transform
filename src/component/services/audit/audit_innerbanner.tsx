...
export default function AuditInnerbanner() {
  return (
            ...
            <div className="col-lg-6 col-md-12">
              <div className="innerbannercontent">
                <h1 className="sectitle">
                  <span>Legacy Software</span>Audit And Assessment Services
                </h1>
                <p className="fs-16">
                  Is this the right time to renew your legacy software? Get an
                  in-depth audit and assessment done for your business software
                  systems to find the exact answer. Our legacy software audit
                  and assessment services include evaluating your software from
                  business, technical, and organizational perspectives.
                </p>
                <div className="underlinetitle underlinetitleleft fw-bold mb-3">
                  What We offer
                </div>
                <ul className="bannerlistingwrapper">
                  <li>Assessment of Software Quality & Security</li>
                  <li>Review Software licenses and compliance</li>
                  <li>Assess System Assets & Performance</li>
                  <li>Suggestions on Potential Improvements</li>
                </ul>
              </div>
            </div>
            <div className="col-lg-6 col-md-12">
